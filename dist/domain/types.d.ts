export type CustodyMode = "no-plaintext-backend" | "backend-custody" | "local-only";
export type SessionArtifactKind = "json-file" | "env-token" | "directory" | "opaque-bytes";
...
export type RefreshedSession = {
    readonly artifact: SessionArtifact;
    readonly providerState: "unchanged" | "refreshed" | "needs-reconnect" | "quota-limited" | "permission-required";
...
export type ProviderSetupMode = "manual-secret" | "device-auth" | "browser-auth" | "api-key" | "import-local-session";
...
export type ProviderRefreshMode = "none" | "validate-only" | "always-before-run" | "lazy-refresh";
...
export type SessionFreshnessAssessment = {
    ...
    readonly reason: "recent_refresh" | "expires_later" | "provider_considers_fresh";
    readonly refreshedAt?: Date;
    readonly expiresAt?: Date;
    readonly warnings: readonly RuntimeWarning[];
} | {
    readonly status: "refresh_recommended";
    readonly reason: "expires_soon" | "expired" | "max_age_exceeded" | "freshness_unknown" | "provider_considers_stale";
    readonly refreshedAt?: Date;
    readonly expiresAt?: Date;
    readonly warnings: readonly RuntimeWarning[];
};
...
export type RefreshSessionResult = {
    ...
    readonly reason: "provider_reconnect_required" | "permission_required" | "quota_limited";
    readonly safeMessage: string;
    readonly warnings: readonly RuntimeWarning[];
} | {
    readonly status: "skipped";
    readonly reason: "stale_generation" | "session_unchanged" | "refresh_not_required";
    readonly session?: SessionEnvelope;
    readonly warnings: readonly RuntimeWarning[];
};
export type RefreshThenRunResult = {
    ...
    readonly status: "blocked";
    readonly reason: "provider_reconnect_required" | "permission_required" | "quota_limited" | "stale_generation" | "task_mode_unsupported";
    readonly safeMessage: string;
    readonly warnings: readonly RuntimeWarning[];
};
